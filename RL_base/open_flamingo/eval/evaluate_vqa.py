...
from RL_base.open_flamingo.eval.coco_metric import compute_cider, postprocess_captioning_generation
from RL_base.open_flamingo.eval.eval_datasets import VQADataset
from tqdm import tqdm

from RL_base.open_flamingo.eval.classification_utils import (
    IMAGENET_CLASSNAMES,
...
from RL_base.open_flamingo.eval.eval_model import BaseEvalModel

from RL_base.open_flamingo.eval.ok_vqa_utils import postprocess_ok_vqa_generation
from RL_base.open_flamingo.src.flamingo import Flamingo
from RL_base.open_flamingo.eval.vqa_metric import compute_vqa_accuracy, postprocess_vqa_generation

from RL_base.open_flamingo.train.distributed import init_distributed_device, world_info_from_env
...
parser.add_argument(
    "--retrieval_name",
    type=str,
    default="VQAv2_Result_file_name",
