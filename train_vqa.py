...
import clip
from RL_base.policy_model import AdaptiveMultiModalMatchingModel
...
def parse_args():
    ...
    parser.add_argument('--resume_checkpoint', type=str,
                        default="/path/to/AMSM/log/ofv2_base/END_OUTPUT_linear/okvqa/policy_model_epoch_3.pth",
    ...
    parser.add_argument(
        ...
        default='/path/to/AMSM/data/okvqa_labeled_confidence.json',
    )
    parser.add_argument(
        "--image_dir",
        type=str,
