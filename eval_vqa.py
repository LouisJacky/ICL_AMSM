from RL_base.policy_model_eval_okvqa import parse_args as eval_parse_args, load_trained_policy_model, get_okvqa_dataloader, \
    evaluate_policy_model
from RL_base.policy_model_score_okvqa import main as score_main, parse_args as score_parse_args
